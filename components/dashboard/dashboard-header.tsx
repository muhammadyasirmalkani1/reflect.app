...
import { Search, Home, TrendingUp, Wallet, Eye, Users, Bell, Settings, LogOut, User, Shield } from "lucide-react"
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-white font-bold text-xl">Vault</span>
            </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <Button variant="ghost" size="sm" className="relative text-slate-300 hover:text-white">
              ...
              <Badge className="absolute -top-1 -right-1 w-5 h-5 p-0 bg-blue-600 text-white text-xs flex items-center justify-center">
                3
              </Badge>
            </Button>
