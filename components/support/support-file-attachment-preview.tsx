...
interface SupportFileAttachmentPreviewProps {
  file: File
  preview: string
  onRemove: () => void
}

export default function SupportFileAttachmentPreview({ file, preview, onRemove }: SupportFileAttachmentPreviewProps) {
